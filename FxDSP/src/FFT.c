           ...
           float*           outPhase)
{
    ...
    FFTForwardInterleaved(fft,(DSPComplex*)inBuffer,(DSPComplex*)out);
            ...
            float       *dest)
{
    ...
    //Calculate FFT of the two signals
    FFTForwardSplit(fft, (DSPComplex*)in1_padded, &fft->split);
    FFTForwardSplit(fft, (DSPComplex*)in2_padded, &fft->split2);
                  ...
                  float*            dest)
{
    ...
    FFTForwardSplit(fft, (DSPComplex*)in_padded, &fft->split);
